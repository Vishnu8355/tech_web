      ...
      <div className="flex flex-wrap">
        <div className="w-full md:w-1/2 pt-6 mb-10 md:mb-0">
          <h3 className="mb-1 text-2xl font-bold text-white">
            <span className="text-green-300">mega Offers on</span>
            <span>New Product</span>
          </h3>
          <p className="mb-8 md:mb-16 text-sm font-medium text-indigo-100">
            Upto 10% Discount on first Order
          </p>
        ...
        <div className="w-full md:w-1/2 flex items-center">
          <img
            ...
            src="https://images.unsplash.com/photo-1534723452862-4c874018d66d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8c3RvcmV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"
            alt=""
          />
        </div>
      </div>
